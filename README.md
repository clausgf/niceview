...
| `18_form_actions.py` | Actions — `FormAction`, `'@name'` in the layout, `chrome_actions` in every wrapper's title row, `list_actions`/`detail_actions` for `DrillDownWrapper`'s two views |
